...
* [SDK](#sdk)
  * [The Quiq object](#the-quiq-object)
    ...
    * [getHandle](#gethandle)
    * [on](#on)
    * [setChatRegistrationField](#setChatRegistrationField)
...
* #### icons
  * type:
    ...
    ```
  * description: Defines favicons and other icons for use by the browser. Note that these images **must** be served over HTTPS. The only browsers which will display a custom favIcon in the title bar are Chrome and IE on Windows. On other browsers, custom icons are only used for bookmarks.
  * default: `{}`
  * example:
    ```javascript
    {
...
* #### messages
  ...
  * default:
    ```javascript
    {
      ...
      invalidEmailErrorMessage: 'Please enter a valid e-mail',
      ...
      agentAssignedMessage: 'You're chatting with {agent_name}',
